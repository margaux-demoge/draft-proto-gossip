...
| 5   | Critical | What are the 10-30 themes in DRAFT's question library?                                                                                                                                        | Margaux       |                                                                                                                                                                                              |        |
...
| 29  | Medium   | How much does it cost in LLM API calls to run DRAFT for one user per day? (2 personalized questions + follow-ups + card generation = multiple calls. At 1000 users, what's the monthly bill?) | Engineering   | Ask engineering to estimate.                                                                                                                                                                 | To do  |
