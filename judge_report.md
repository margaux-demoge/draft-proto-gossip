...
| 9   | Critical | What is the follow-up stopping trigger?                                                                                    | Single mode: natural conversation, curious but not insistent. DRAFT asks follow-up questions to show interest but never feels like an interrogation. No mode switching. **Work still to do:** implement in prompts. Owner: Aymeric + eng. |
